  ...
  const buildPreset: Record<BuildFlags['channel'], BUILD_CONFIG_TYPE> = {
    get stable() {
      return {
        ...
        githubUrl: 'https://github.com/oiy-ai/learnify',
        changelogUrl: 'https://github.com/oiy-ai/learnify/releases',
        downloadUrl: 'https://learnify.oiy.ai/download',
        pricingUrl: 'https://learnify.oiy.ai/pricing',
        discordUrl: 'https://learnify.oiy.ai/redirect/discord',
        requestLicenseUrl: 'https://learnify.oiy.ai/redirect/license',
