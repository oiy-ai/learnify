...
export interface EmptyNoteDetailProps extends UniversalEmptyProps {
...
export const EmptyNoteDetail = ({
  ...
  return (
    <EmptyLayout
      ...
      title={t['com.learnify.empty.note-detail.title']()}
      description={t['com.learnify.empty.note-detail.description']()}
      action={
