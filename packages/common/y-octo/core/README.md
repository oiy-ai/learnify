...
[AFFiNE](https://affine.pro) is using y-octo in production. There are [Electron](https://affine.pro/download) app and [Node.js server](https://github.com/a1exsun/learnify/tree/canary/packages/backend/native) using y-octo in production.
